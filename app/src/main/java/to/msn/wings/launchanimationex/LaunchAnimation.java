...
/**
 * Created by 4163201 on 2017/09/26.
 */

public class LaunchAnimation extends Activity implements View.OnClickListener {
    ...
    public void onClick(View view){
        ...
        //サムネイルスケールアップアニメーション
            ...
            ActivityOptions opts = ActivityOptions.makeThumbnailScaleUpAnimation(view, bmp, 0, 0);
            startActivity(new Intent(this, MyActivity.class), opts.toBundle());
